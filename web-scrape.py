...
for page in range(0,int(page_nr)*10,10):
    ...
    all=soup.find_all("div",{"class":"propertyRow"})
    print(all)
#Render scraped website data in list, dictionary format
    for item in all:
        d={}
